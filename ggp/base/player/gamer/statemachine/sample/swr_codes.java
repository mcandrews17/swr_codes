...
public final class swr_codes extends SampleGamer
{
...
//		System.out.println(bestMove);
	...
	public StateMachine getInitialStateMachine() {
		return new CachedStateMachine(new ProverStateMachine()); //Cached(PropNetStateMachine), and change all the method names above to the ones in PNSM.java
	}
